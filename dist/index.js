...
function useTocNavigation(items, { headerOffset = 88 } = {}) {
  ...
  const articleTopsRef = useRef([]);
  const tocYsRef = useRef([]);
...
function TocNav({
  ...
  const chevron = icon ?? /* @__PURE__ */ jsx(DefaultChevron, {});
  const navStyle = position === "right" ? {
    right: containerWidth ? `max(1rem, calc((100vw - ${containerWidth}) / 2 - 13rem - 1.5rem))` : "1rem"
  } : void 0;
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    position !== "inline" && /* @__PURE__ */ jsxs("div", { className: "xl:hidden mb-8 rounded-lg border border-border/40 bg-muted/30 overflow-hidden", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: label }),
            /* @__PURE__ */ jsx(
              "span",
              {
                className: cn(
      ...
      mobileOpen && /* @__PURE__ */ jsx("ul", { id: "toc-mobile-list", className: "flex flex-col pb-2 border-t border-border/40", children: items.map((item) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
        "a",
        {
          href: `#${item.id}`,
          onClick: (e) => {
    ...
    /* @__PURE__ */ jsxs(
      "nav",
      {
        ...
        style: navStyle,
        children: [
          /* @__PURE__ */ jsx("p", { className: "mb-2.5 text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/50 pl-6", children: label }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            svgPath && /* @__PURE__ */ jsxs(
              "svg",
              {
                width: 20,
                height: svgH,
                ...
                "aria-hidden": true,
                children: [
                  /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("clipPath", { id: "toc-viewport-clip", children: /* @__PURE__ */ jsx("rect", { ref: clipRectRef, x: -10, y: 0, width: 40, height: 0 }) }) }),
                  /* @__PURE__ */ jsx(
                    "path",
                    {
                      d: svgPath,
                  ...
                  /* @__PURE__ */ jsxs("g", { ref: dotGroupRef, transform: "translate(-100,-100)", children: [
                    /* @__PURE__ */ jsx("circle", { r: 5.5, style: { fill: "var(--color-background, #ffffff)" } }),
                    /* @__PURE__ */ jsx("circle", { r: 3, style: { fill: "var(--color-primary, #3b82f6)" } })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsx("ul", { ref: listRef, className: "flex flex-col", children: items.map((item) => {
